...
function [I0, HR_bic, HR_Proposed] = interface(I0, parameter)
...
I0  = modcrop((I0), sf);
LR_noisy = I0;
kernelsigma = 1;     % width (sigma) of the Gaussian blur kernel
...
%{,
disp('========== Proposed ============');
Isigma      = parameter/255; % default 0.5/255 for noise-free case. It should be larger than noisesigma, e.g., Isigma = noisesigma + 2/255;
