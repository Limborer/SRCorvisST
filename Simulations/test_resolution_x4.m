...
% read image
I0 = (imread('RealData/Li_Xin_Left/Li_Xin_Left_20170809_0932010043.tif'));
I0 = (imread('RealData/Li_Xin_Left/Li_Xin_Left_20170809_0932010043.tif'));
I0 = (imread('RealData/Li_Xin_Left/Li_Xin_Left_20170809_0932010043.tif'));
I0 = (imread('RealData/Li_Xin_Left/Li_Xin_Left_20170809_0932010043.tif'));
% I0 = (imread('RealData/Lv_Huijie/Lv_Huijie_Left_20170802_1358330051.tif'));
 I0 = (imread('RealData/Zhao_Dongyu_Right_20170731_0831/Zhao_Dongyu_Right_20170731_0831000054.tif'));
%%
%%%%%%%%%%%%%%%%%%%%%% image degradation %%%%%%%%%%%%%%%%%%%%
sf = 4; % scale factor
I0  = modcrop((I0), sf);
...
LR_noisy = I0;
kernelsigma = max(sf-3,1);     % width (sigma) of the Gaussian blur kernel
k       = fspecial('gaussian', sf + 5, kernelsigma);
...
Msigma      = 100;    % noise level of last denoiser
...
HR_Proposed = double(output)*255-20;

%%
subplot(2,1,1); imshow(LR_noisy(1:160,:),[]);
subplot(2,1,2); imshow([(HR_Proposed(1:160*sf,:))],[0 200])
