...
Msigma      = 1000;    % noise level of last denoiser
...
HR_SPMSR = Interface_SPMSR(im_l, sf);
...
%%
imshow(I0,[0 255])
saveas(gcf,'Simulations/Results/I0.eps');

imshow(LR_noisy*255,[0 255])
saveas(gcf,'Simulations/Results/LR.eps');


imshow(HR_bic*255,[0 255])
saveas(gcf,'Simulations/Results/Bicubic.eps');

imshow(HR_SPMSR*255,[0 255])
saveas(gcf,'Simulations/Results/HR_SPMSR.eps');

imshow(HR_SRCNN*255,[0 255])
saveas(gcf,'Simulations/Results/HR_SRCNN.eps');

imshow(HR_Proposed,[0 255])
saveas(gcf,'Simulations/Results/Proposed.eps');