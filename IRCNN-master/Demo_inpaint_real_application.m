...
% A = aux_stackread('../../Liu_Xuezhen_Right_20170828_090041.tif');
% Iori = A(:,:,49);
Iori = im2single(imread('31531194944_.pic_hd.jpg'));
window = 50;
...
mask = Iori>230/255;
region = zeros(size(mask));
region(80:248,60:570) = 1;
mask = mask.*region;
...
Isigma = 0.1/255; % ****** from interval [1/255, 20/255] ******; e.g., 1/255, 2.55/255, 7/255, 11/255
% (2) noise level of the last denoiser: Msigma
Msigma = 1; % ****** from {1 3 5 7 9 11 13 15} ******
%--------------------------------------------------------
