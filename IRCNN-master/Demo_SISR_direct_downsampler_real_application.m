...
Isigma      = 12/255; % default 1/255 for noise-free case. It should be larger than true noise level.
...
%%
subplot(2,1,1); imshow(LR,[]); subplot(2,1,2); imshow(output,[]);
return
if showResult
